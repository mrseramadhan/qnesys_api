                    ...
                    <div class="tm-blue-bg tm-left-column">
                        ...
                        <nav class="tm-main-nav" style="overflow-y: scroll; height: 60%;">
                            <ul class="tm-main-nav-ul">
                                ...
                                <li class="tm-nav-item">
                                    <a href="#update04092020" class="tm-nav-item-link">UPDATE 04092020</a>
                                </li>
                                <li class="tm-nav-item">
                                ...
                                <li class="tm-nav-item">
                                    <a href="#around-hotel-category" class="tm-nav-item-link">Around Hotel Category</a>
                                </li>
                                <li class="tm-nav-item">
                                ...
                                <li class="tm-nav-item">
                                    <a href="#ads" class="tm-nav-item-link">Master Ads</a>
                                </li>
                                <li class="tm-nav-item">
                                    <a href="#child_ads" class="tm-nav-item-link">Child Ads</a>
                                </li>
                                <li class="tm-nav-item">
                                    <a href="#adsiptvlocationtype" class="tm-nav-item-link">Ads IPTV Location</a>
                                </li>
                                <li class="tm-nav-item">
                                    <a href="#adsiptvlocation" class="tm-nav-item-link">Ads IPTV Trx</a>
                                </li>
                                <li class="tm-nav-item">
                                ...
                                <li class="tm-nav-item">
                                    <a href="#menuservice" class="tm-nav-item-link">Menu Service</a>
                                </li>
                                <li class="tm-nav-item">
                                ...
                                <li class="tm-nav-item">
                                    <a href="#status_clean_my_room" class="tm-nav-item-link">Status Clean My Room</a>
                                </li>
                                <li class="tm-nav-item">
                                    <a href="#status_dnd" class="tm-nav-item-link">Status DND</a>
                                </li>
                                <li class="tm-nav-item">
                                    <a href="#status_tv" class="tm-nav-item-link">Status TV</a>
                                </li>
                                <li class="tm-nav-item">
                                    <a href="#status_ac" class="tm-nav-item-link">Status AC</a>
                                </li>
                                <li class="tm-nav-item">
                                    <a href="#status_smart_lock" class="tm-nav-item-link">Status Smart Lock</a>
                                </li>
                                <li class="tm-nav-item">
                                    <a href="#status_light" class="tm-nav-item-link">Status Light</a>
                                </li>
                                <li class="tm-nav-item">
                                    <a href="#room-hardware" class="tm-nav-item-link">Room Hardware / Room Utitilies</a>
                                </li>
                                <li class="tm-nav-item">
                                    <a href="#smart_ir" class="tm-nav-item-link">Smart IR</a>
                                </li>
                                <li class="tm-nav-item">
                                    <a href="#smart_lock" class="tm-nav-item-link">Smart Lock</a>
                                </li>
                                <li class="tm-nav-item">
                                    <a href="#smart_switch" class="tm-nav-item-link">Smart Switch</a>
                                </li>
                            </ul>
                        </nav>
...
// }
                            ...
                            <section id="update07092020" class="tm-section">
                                <header>
                                    <h2 class="tm-blue-text tm-welcome-title tm-margin-b-45">Update 07-09-2020</h2>
                                </header>
                                <div class="row">
                                  <div class="col col-md-12">
                                      <ul>
                                        <li>Penambahan API SmartLock</li>
                                        <li>Penambahan API SmartSwitch</li>
                                        <li>Penambahan API SmartIR</li>
                                        <li>Penambahan API StatusCleanMyRoom</li>
                                        <li>Penambahan API StatusDND</li>
                                        <li>Penambahan API StatusTV</li>
                                        <li>Penambahan API StatusAC</li>
                                        <li>Penambahan API StatusSmartLock</li>
                                        <li>Penambahan API StatusLight</li>
                                        <!-- <li>Penambahan API TVMenuAnalytic</li>
                                        <li>Penambahan API ChannelTVAnalytic</li>
                                        <li>Penambahan API MobileMenuAnalytic</li> -->
                                        <li>Pengantian nama API Ads menjadi AdsMaster</li>
                                        <li>Pengantian nama API AdsIPTVLocationType menjadi AdsLocation dan penambahan Duration, dan beberapa attribute master ads ke ads trx yaitu type, range_time</li>
                                        <li>Pengantian nama API AdsIPTVLocation menjadi AdsTrx</li>
                                        <li>Penambahan API Ads Child mengarah ke parent AdsMaster</li>
                                        <li>Penambahan API AroundHotelCategory mengarah ke parent AroundHotel</li>
                                      </ul>
                                  </div>
                                </div>
                            </section>
                            <section id="update04092020" class="tm-section">
                                <header>
                                    <h2 class="tm-blue-text tm-welcome-title tm-margin-b-45">Update 04-09-2020</h2>
                                </header>
                                <div class="row">
                                  <div class="col col-md-12">
                                      <ul>
                                        <li>Penambahan API (GetMenuService, PostMenuService, DeleteMenuService)</li>
                                        <li>Penambahan Attribute pada API Hotel yaitu (hotel_code) AUTOGENERATE</li>
                                        <li>Penambahan attribute pada API Around Hotel yaitu (lat, lng)</li>
                                        <li>Penambahan attribute pada API SSID yaitu (lantai)</li>
                                        <li>Penambahan attribute pada API Room yaitu (lantai)</li>
                                        <li>Perubahan attribute pada API Food yaitu qty menjadi available_qty</li>
                                        <li>Penambahan attribute pada API Category Galery yaitu (id_hotel)</li>
                                        <li>Penambahan attribute pada API Event yaitu (lat,lng,tempat,kota)</li>
                                        <li>Penambahan attribute pada API Facilities Category yaitu (description dan id_galery)</li>
                                        <li>Penambahan data statis pada API Category Galery yaitu (id_category_galery = 3, category_galery_name = Hotel Facility)</li>
                                        <li>Penambahan attribute pada API Hotel Facilities yaitu (jam_operasi)</li>
                                        <li>Penambahan attribute pada API Galery yaitu (galery_name, description)</li>
                                      </ul>
                                  </div>
                                </div>
                            </section>
        ...
        },
        {
            ...
            "updated_at": "2020-08-10T21:00:51.000000Z"
                            ...
                            <section id="ads" class="tm-section">
                                <header>
                                    <h2 class="tm-blue-text tm-welcome-title tm-margin-b-45">Master Ads</h2>
                                </header>
                                <div class="row">
                                  <div class="col-md-12">
                                    <div class="card" style="padding: 20px;">
                                      <b class="btn btn-success">POST</b> <strong><?=$DOMAIN?>/api/GetMasterAds</strong>
    ...
    "data": [
        {
            ...
            "updated_at": "2020-08-27 14:16:42"
                                ...
                                <div class="col-md-12">
                                  <div class="card" style="padding: 20px;">
                                    <b class="btn btn-primary">POST</b> <strong><?=$DOMAIN?>/api/PostMasterAds</strong>
                                    ...
                                    <tr>
                                      <td>id_hotel</td>
                                      <td>INT (11)</td>
                                      <td>(GET DATA dan pilih dari id <strong><?=$DOMAIN?>/api/</strong>)</td>
                                      <td><span class="btn btn-success btn-block">YES</span></td>
                                      <td><span class="btn btn-success btn-block">YES</span></td>
                                    </tr>
                                    <tr>
                                ...
                                <div class="col-md-12">
                                 <div class="card" style="padding: 20px;">
                                   <b class="btn btn-danger">POST</b> <strong><?=$DOMAIN?>/api/DeleteMasterAds</strong>
                            ...
                            <section id="child_ads" class="tm-section">
                                <header>
                                    <h2 class="tm-blue-text tm-welcome-title tm-margin-b-45">Child Ads</h2>
                                </header>
                                <div class="row">
                                  <div class="col-md-12">
                                    <div class="card" style="padding: 20px;">
                                      <b class="btn btn-success">POST</b> <strong><?=$DOMAIN?>/api/GetChildAds</strong>
                                      <p>adalah Child Iklan, digunakan untuk mengambil list data, digunakan user dari Qynesis, data ini digunakan sebagai child iklan per-hotel</p>
                                      <center><h3 class="text-center"><a href="#get">GET DATA REQUEST FORMAT</a></h3></center>
                                      <hr>
                                        <h4>Response Body: </h4>
                                        <hr>
    ...
    "data": [
        {
            ...
            "updated_at": "2020-08-27 14:16:42"
                                ...
                                <div class="col-md-12">
                                  <div class="card" style="padding: 20px;">
                                    <b class="btn btn-primary">POST</b> <strong><?=$DOMAIN?>/api/PostChildrAds</strong>
                                    <p>digunakan untuk menambah/mengubah data child ads, digunakan user dari Qynesis</p>
                                    <hr>
                                    <h4>Request Header: </h4>
                                    <hr>
                                    <table border="1" width="100%">
                                    ...
                                    <tr>
                                      <td>id_master_ads</td>
                                      <td>INT (11)</td>
                                      <td>(GET DATA dan pilih dari id <strong><?=$DOMAIN?>/api/GetMasterAds</strong>)</td>
                                      <td><span class="btn btn-success btn-block">YES</span></td>
                                      <td><span class="btn btn-success btn-block">YES</span></td>
                                    </tr>
                                    <tr>
                                ...
                                <div class="col-md-12">
                                 <div class="card" style="padding: 20px;">
                                   <b class="btn btn-danger">POST</b> <strong><?=$DOMAIN?>/api/DeleteChildAds</strong>
                                   <p>digunakan untuk menghapus data master ads, digunakan user dari Qynesis</p>
                                   <hr>
                                   <h4>Request Header: </h4>
                                   <hr>
                            ...
                            <section id="adsiptvlocationtype" class="tm-section">
                                <header>
                                    <h2 class="tm-blue-text tm-welcome-title tm-margin-b-45">Ads IPTV Location (Master Location Ads IPTV)</h2>
                                </header>
                                <div class="row">
                                  <div class="col-md-12">
                                    <div class="card" style="padding: 20px;">
            ...
            "updated_at": "2020-08-27T16:17:08.000000Z"
                                ...
                                <div class="col-md-12">
                                  <div class="card" style="padding: 20px;">
                                    ...
                                    <p>digunakan untuk menambah/mengubah data IPTV Location, digunakan user statis IPTV</p>
                                    <hr>
                                    <h4>Request Header: </h4>
                                    <hr>
                                    <table border="1" width="100%">
                                ...
                                <div class="col-md-12">
                                 <div class="card" style="padding: 20px;">
                                   ...
                                   <p>digunakan untuk hapus data IPTV Location, digunakan user statis IPTV</p>
                                   <hr>
                                   <h4>Request Header: </h4>
                                   <hr>
                                   <table border="1" width="100%">
                            ...
                            <section id="adsiptvlocation" class="tm-section">
                                <header>
                                    <h2 class="tm-blue-text tm-welcome-title tm-margin-b-45">Ads IPTV Trx (Position per-IPTV)</h2>
                                </header>
                                <div class="row">
                                  <div class="col-md-12">
                                    <div class="card" style="padding: 20px;">
                                      <b class="btn btn-success">POST</b> <strong><?=$DOMAIN?>/api/GetAdsIPTVTrx</strong>
    ...
    "data": [
        {
            ...
            "updated_at": "2020-08-27T17:04:43.000000Z"
                                ...
                                <div class="col-md-12">
                                  <div class="card" style="padding: 20px;">
                                    <b class="btn btn-primary">POST</b> <strong><?=$DOMAIN?>/api/PostAdsIPTVTrx</strong>
                                    ...
                                    <tr>
                                      <td>id_ads_location</td>
                                      <td>INT (11)</td>
                                      <td>(GET DATA dari <strong><?=$DOMAIN?>/api/GetAdsIPTVLocation</strong>)</td>
                                      <td><span class="btn btn-success btn-block">YES</span></td>
                                      <td><span class="btn btn-success btn-block">YES</span></td>
                                    </tr>
                                    <tr>
                                      <td>id_master_ads</td>
                                      <td>INT (11)</td>
                                      <td>(GET DATA dari <strong><?=$DOMAIN?>/api/GetMasterAds</strong>)</td>
                                      <td><span class="btn btn-success btn-block">YES</span></td>
                                      <td><span class="btn btn-success btn-block">YES</span></td>
                                    </tr>
                                    <tr>
                                ...
                                <div class="col-md-12">
                                 <div class="card" style="padding: 20px;">
                                   <b class="btn btn-danger">POST</b> <strong><?=$DOMAIN?>/api/DeleteAdsIPTVTrx</strong>
    ...
    "data": [
        {
            ...
            "hotel_code": "QNESYS_kc04ni109P420J5y15Vh419Bc51",
        ...
        },
        {
            ...
            "id_corporation": "1",
            "hotel_name": "Ritz Calton",
            "hotel_code": "QNESYS_ZR04ni109P420J5y15Vh419Bc51",
            "hotel_address": "Jl. DR. Ide Anak Agung Gde Agung Kav.E.1.1 No. 1, Kuningan, Daerah Khusus Ibukota Jakarta 12950",
            "hotel_phone": "(021) 25518888",
            "pos_code": "12950",
            "code_provinsi": "1",
            ...
            "updated_at": "2020-08-10T22:38:16.000000Z"
                                ...
                                <div class="col-md-12">
                                  <div class="card" style="padding: 20px;">
                                    ...
                                    <tr>
                                      <td>id_category_around_hotel</td>
                                      <td>INT (11)</td>
                                      <td>(GET DATA dari <strong><?=$DOMAIN?>/api/GetCategoryAroundHotel</strong>)</td>
                                      <td><span class="btn btn-success btn-block">YES</span></td>
                                      <td><span class="btn btn-success btn-block">YES</span></td>
                                    </tr>
                                    <tr>
                            ...
                            <section id="around-hotel-category" class="tm-section">
                                <header>
                                    <h2 class="tm-blue-text tm-welcome-title tm-margin-b-45">Category Around Hotel</h2>
                                </header>
                                <div class="row">
                                  <div class="col-md-12">
                                    <div class="card" style="padding: 20px;">
                                      <b class="btn btn-success">POST</b> <strong><?=$DOMAIN?>/api/GetCategoryAroundHotel</strong>
                                      <p>adalah kategory informasi sekitar hotel, digunakan untuk mengambil list data kategory sekitar hotel, mengunakan user qnesys/hotel, data ini digunakan sebagai kategory sekitar hotel</p>
                                      <center><h3 class="text-center"><a href="#get">GET DATA REQUEST FORMAT</a></h3></center>
                                      <hr>
                                        <h4>Response Body: </h4>
                                        <hr>
<pre>
{
    ...
    "failed": 0,
    "message": "Data was found 1",
    "primary_key": "id_category_around_hotel",
    "type": "list",
    "count": 1,
    "data": [
        {
            "id_category_around_hotel": 4,
            "id_hotel": 2,
            ...
            "updated_at": "2020-08-10T22:27:02.000000Z"
                                ...
                                <div class="col-md-12">
                                  <div class="card" style="padding: 20px;">
                                    <b class="btn btn-primary">POST</b> <strong><?=$DOMAIN?>/api/PostCategoryAroundHotel</strong>
                                    <p>digunakan untuk menambah/mengubah data kategori sekitar hotel, mengunakan token user qnesys/hotel</p>
                                    <hr>
                                    <h4>Request Header: </h4>
                                    <hr>
                                    <table border="1" width="100%">
                                ...
                                <div class="col-md-12">
                                 <div class="card" style="padding: 20px;">
                                   <b class="btn btn-danger">POST</b> <strong><?=$DOMAIN?>/api/DeleteCategoryAroundHotel</strong>
                                   <p>digunakan untuk menghapus data sekitar hotel, mengunakan token user qnesys / hotel</p>
                                   <hr>
                                   <h4>Request Header: </h4>
                                   <hr>
                                   ...
                                   <tr>
                                     <td>id_cateogry_around_hotel</td>
                                     <td>INT (11)</td>
                                     <td>1</td>
                                     <td><span class="btn btn-success btn-block">YES</span></td>
                                   </tr>
                                ...
                                <div class="col-md-12">
                                  <div class="card" style="padding: 20px;">
                                    ...
                                    <tr>
                                      <td>id_galery</td>
                                      <td>INT (11)</td>
                                      <td>(GET DATA melalui <strong><?=$DOMAIN?>/api/GetGalery</strong>)</td>
                                      <td><span class="btn btn-success btn-block">YES</span></td>
                                      <td><span class="btn btn-success btn-block">YES</span></td>
                                    </tr>
                                    <tr>
    ...
    "data": [
        ...
        },
        {
            ...
            "updated_at": "2020-08-10T21:01:41.000000Z"
                            ...
                            <section id="menuservice" class="tm-section">
                                <header>
                                    <h2 class="tm-blue-text tm-welcome-title tm-margin-b-45">Menu Service</h2>
                                </header>
                                <div class="row">
                                  <div class="col-md-12">
                                    <div class="card" style="padding: 20px;">
                                      <b class="btn btn-success">POST</b> <strong><?=$DOMAIN?>/api/GetMenuService</strong>
                                      <p>adalah data menu pelayanan, digunakan untuk mengambil data pelayanan, mengunakan user qnesys/hotel, data ini digunakan sebagai informasi menu pelayanan</p>
                                      <center><h3 class="text-center"><a href="#get">GET DATA REQUEST FORMAT</a></h3></center>
                                      <hr>
                                        <h4>Response Body: </h4>
                                        <hr>
      ...
      "data": [
          {
              ...
              "picture": "MENUSERVICE_04092020151228.jpeg",
              "icon": "cleaning-service",
              "direct_to_api": "GetService",
              "created_at": "2020-09-04T15:12:28.000000Z",
              "updated_at": "2020-09-04T15:12:28.000000Z"
          }
      ]
  }
</pre>
                                ...
                                <div class="col-md-12">
                                  <div class="card" style="padding: 20px;">
                                    <b class="btn btn-primary">POST</b> <strong><?=$DOMAIN?>/api/PostMenuService</strong>
                                    ...
                                    <tr>
                                      <td>id_hotel</td>
                                      <td>INT (11)</td>
                                      <td>(Melakukan ambil data <strong><?=$DOMAIN?>/api/GetMenuService</strong>)</td>
                                    ...
                                    <tr>
                                      <td>description</td>
                                      <td>TEXT</td>
                                      <td>For see list DND please click ....</td>
                                      <td><span class="btn btn-success btn-block">YES</span></td>
                                      <td><span class="btn btn-success btn-block">YES</span></td>
                                    </tr>
                                    <tr>
                                ...
                                <div class="col-md-12">
                                 <div class="card" style="padding: 20px;">
                                   <b class="btn btn-danger">POST</b> <strong><?=$DOMAIN?>/api/DeleteMenuService</strong>
      ...
      "data": [
          ...
          },
          {
              ...
              "updated_at": "2020-08-06T10:48:21.000000Z"
                            ...
                            <section id="status_clean_my_room" class="tm-section">
                                <header>
                                    <h2 class="tm-blue-text tm-welcome-title tm-margin-b-45">Status Clean My Room</h2>
                                </header>
                                <div class="row">
                                  <div class="col-md-12">
                                    <div class="card" style="padding: 20px;">
                                      <b class="btn btn-success">POST</b> <strong><?=$DOMAIN?>/api/GetStatusCleanMyRoom</strong>
                                      <p>adalah data Status Clean My Room per-Kamar</p>
                                      <center><h3 class="text-center"><a href="#get">GET DATA REQUEST FORMAT</a></h3></center>
                                      <hr>
                                        <h4>Response Body: </h4>
                                        <hr>
<pre>
  {
      ...
      "failed": 0,
      "message": ", Data was found 1",
      "primary_key": "id_status_clean_my_room",
      "type": "list",
      "count": 1,
      "data": [
          {
              "id_status_clean_my_room": 1,
              "id_room": "6",
              "status": "1",
              "created_at": "2020-09-07T11:17:24.000000Z",
              "updated_at": "2020-09-07T11:17:24.000000Z"
          }
      ]
  }
</pre>
                                ...
                                <div class="col-md-12">
                                  <div class="card" style="padding: 20px;">
                                    <b class="btn btn-primary">POST</b> <strong><?=$DOMAIN?>/api/PostStatusCleanMyRoom</strong>
                                    <p>digunakan untuk menambah/mengubah data status clean my room per kamar</p>
                                    <hr>
                                    <h4>Request Header: </h4>
                                    <hr>
                                    <table border="1" width="100%">
                                ...
                                <div class="col-md-12">
                                 <div class="card" style="padding: 20px;">
                                   <b class="btn btn-danger">POST</b> <strong><?=$DOMAIN?>/api/DeleteStatusCleanMyRoom</strong>
                                   <p>digunakan untuk menghapus data status clean my room, mengunakan token user qnesys/hotel</p>
                                   <hr>
                                   <h4>Request Header: </h4>
                                   <hr>
                                   <table border="1" width="100%">
                            ...
                            <section id="status_dnd" class="tm-section">
                                <header>
                                    <h2 class="tm-blue-text tm-welcome-title tm-margin-b-45">Status DND</h2>
                                </header>
                                <div class="row">
                                  <div class="col-md-12">
                                    <div class="card" style="padding: 20px;">
                                      <b class="btn btn-success">POST</b> <strong><?=$DOMAIN?>/api/GetStatusDND</strong>
                                      <p>adalah data Status DND per-Kamar</p>
                                      <center><h3 class="text-center"><a href="#get">GET DATA REQUEST FORMAT</a></h3></center>
                                      <hr>
                                        <h4>Response Body: </h4>
                                        <hr>
      ...
      "data": [
          {
              ...
              "updated_at": "2020-09-07T11:17:24.000000Z"
                                ...
                                <div class="col-md-12">
                                  <div class="card" style="padding: 20px;">
                                    <b class="btn btn-primary">POST</b> <strong><?=$DOMAIN?>/api/PostStatusDND</strong>
                                    <p>digunakan untuk menambah/mengubah data status clean my room per kamar</p>
                                    <hr>
                                    <h4>Request Header: </h4>
                                    <hr>
                                ...
                                <div class="col-md-12">
                                 <div class="card" style="padding: 20px;">
                                   <b class="btn btn-danger">POST</b> <strong><?=$DOMAIN?>/api/DeleteStatusDND</strong>
                                   <p>digunakan untuk menghapus data status dnd, mengunakan token user qnesys/hotel</p>
                                   <hr>
                                   <h4>Request Header: </h4>
                                   <hr>
                                   <table border="1" width="100%">
                            ...
                            <section id="status_tv" class="tm-section">
                                <header>
                                    <h2 class="tm-blue-text tm-welcome-title tm-margin-b-45">Status TV</h2>
                                </header>
                                <div class="row">
                                  <div class="col-md-12">
                                    <div class="card" style="padding: 20px;">
                                      <b class="btn btn-success">POST</b> <strong><?=$DOMAIN?>/api/GetStatusTV</strong>
                                      <p>adalah data Status TV per-Kamar</p>
                                      <center><h3 class="text-center"><a href="#get">GET DATA REQUEST FORMAT</a></h3></center>
                                      <hr>
                                        <h4>Response Body: </h4>
                                        <hr>
      ...
      "data": [
          {
              ...
              "updated_at": "2020-09-07T11:17:24.000000Z"
                                ...
                                <div class="col-md-12">
                                  <div class="card" style="padding: 20px;">
                                    <b class="btn btn-primary">POST</b> <strong><?=$DOMAIN?>/api/PostStatusTV</strong>
                                    <p>digunakan untuk menambah/mengubah data status tv per kamar</p>
                                    <hr>
                                    <h4>Request Header: </h4>
                                    <hr>
                                    <table border="1" width="100%">
                                ...
                                <div class="col-md-12">
                                 <div class="card" style="padding: 20px;">
                                   <b class="btn btn-danger">POST</b> <strong><?=$DOMAIN?>/api/DeleteStatusTV</strong>
                                   <p>digunakan untuk menghapus data status tv, mengunakan token user qnesys/hotel</p>
                                   <hr>
                                   <h4>Request Header: </h4>
                                   <hr>
                                   <table border="1" width="100%">
                            ...
                            <section id="status_ac" class="tm-section">
                                <header>
                                    <h2 class="tm-blue-text tm-welcome-title tm-margin-b-45">Status AC</h2>
                                </header>
                                <div class="row">
                                  <div class="col-md-12">
                                    <div class="card" style="padding: 20px;">
                                      <b class="btn btn-success">POST</b> <strong><?=$DOMAIN?>/api/GetStatusAC</strong>
                                      <p>adalah data Status AC per-Kamar</p>
                                      <center><h3 class="text-center"><a href="#get">GET DATA REQUEST FORMAT</a></h3></center>
                                      <hr>
                                        <h4>Response Body: </h4>
                                        <hr>
      ...
      "data": [
          {
              ...
              "updated_at": "2020-09-07T11:17:24.000000Z"
                                ...
                                <div class="col-md-12">
                                  <div class="card" style="padding: 20px;">
                                    <b class="btn btn-primary">POST</b> <strong><?=$DOMAIN?>/api/PostStatusAC</strong>
                                    <p>digunakan untuk menambah/mengubah data status ac per kamar</p>
                                    <hr>
                                    <h4>Request Header: </h4>
                                    <hr>
                                    <table border="1" width="100%">
                                ...
                                <div class="col-md-12">
                                 <div class="card" style="padding: 20px;">
                                   <b class="btn btn-danger">POST</b> <strong><?=$DOMAIN?>/api/DeleteStatusAC</strong>
                                   <p>digunakan untuk menghapus data status ac, mengunakan token user qnesys/hotel</p>
                                   <hr>
                                   <h4>Request Header: </h4>
                                   <hr>
                                   <table border="1" width="100%">
                            ...
                            <section id="status_smart_lock" class="tm-section">
                                <header>
                                    <h2 class="tm-blue-text tm-welcome-title tm-margin-b-45">Status Smart Lock</h2>
                                </header>
                                <div class="row">
                                  <div class="col-md-12">
                                    <div class="card" style="padding: 20px;">
                                      <b class="btn btn-success">POST</b> <strong><?=$DOMAIN?>/api/GetStatusSmartLock</strong>
                                      <p>adalah data Status Smart Lock per-Kamar</p>
                                      <center><h3 class="text-center"><a href="#get">GET DATA REQUEST FORMAT</a></h3></center>
                                      <hr>
                                        <h4>Response Body: </h4>
                                        <hr>
<pre>
  {
      ...
      "failed": 0,
      "message": ", Data was found 1",
      "primary_key": "id_status_smart_lock",
      "type": "list",
      "count": 1,
      "data": [
          {
              "id_status_smart_lock": 1,
              "id_room": "6",
              "status": "1",
              "created_at": "2020-09-07T11:17:24.000000Z",
              "updated_at": "2020-09-07T11:17:24.000000Z"
                                ...
                                <div class="col-md-12">
                                  <div class="card" style="padding: 20px;">
                                    <b class="btn btn-primary">POST</b> <strong><?=$DOMAIN?>/api/PostStatusSmartLock</strong>
                                    <p>digunakan untuk menambah/mengubah data status smart lock per kamar</p>
                                    <hr>
                                    <h4>Request Header: </h4>
                                    <hr>
                                    <table border="1" width="100%">
                                ...
                                <div class="col-md-12">
                                 <div class="card" style="padding: 20px;">
                                   <b class="btn btn-danger">POST</b> <strong><?=$DOMAIN?>/api/DeleteStatusSmartLock</strong>
                                   <p>digunakan untuk menghapus data status smart lock, mengunakan token user qnesys/hotel</p>
                                   <hr>
                                   <h4>Request Header: </h4>
                                   <hr>
                                   <table border="1" width="100%">
                            ...
                            <section id="status_light" class="tm-section">
                                <header>
                                    <h2 class="tm-blue-text tm-welcome-title tm-margin-b-45">Status Light</h2>
                                </header>
                                <div class="row">
                                  <div class="col-md-12">
                                    <div class="card" style="padding: 20px;">
                                      <b class="btn btn-success">POST</b> <strong><?=$DOMAIN?>/api/GetStatusLight</strong>
                                      <p>adalah data Status Light per-Kamar</p>
                                      <center><h3 class="text-center"><a href="#get">GET DATA REQUEST FORMAT</a></h3></center>
                                      <hr>
                                        <h4>Response Body: </h4>
                                        <hr>
      ...
      "data": [
          {
              ...
              "updated_at": "2020-09-07T11:17:24.000000Z"
                                ...
                                <div class="col-md-12">
                                  <div class="card" style="padding: 20px;">
                                    <b class="btn btn-primary">POST</b> <strong><?=$DOMAIN?>/api/PostStatusLight</strong>
                                    <p>digunakan untuk menambah/mengubah data status light per kamar</p>
                                    <hr>
                                    <h4>Request Header: </h4>
                                    <hr>
                                    <table border="1" width="100%">
                                ...
                                <div class="col-md-12">
                                 <div class="card" style="padding: 20px;">
                                   <b class="btn btn-danger">POST</b> <strong><?=$DOMAIN?>/api/DeleteStatusLight</strong>
                                   <p>digunakan untuk menghapus data status light, mengunakan token user qnesys/hotel</p>
                                   <hr>
                                   <h4>Request Header: </h4>
                                   <hr>
                                   <table border="1" width="100%">
    ...
    "data": [
        ...
        },
        {
            ...
            "updated_at": "2020-08-06T11:38:26.000000Z"
                            ...
                            <section id="smart_ir" class="tm-section">
                                <header>
                                    <h2 class="tm-blue-text tm-welcome-title tm-margin-b-45">Smart IR</h2>
                                </header>
                                <div class="row">
                                  <div class="col-md-12">
                                    <div class="card" style="padding: 20px;">
                                      <b class="btn btn-success">POST</b> <strong><?=$DOMAIN?>/api/GetSmartIR</strong>
                                      <p>adalah Hardware smart IR</p>
                                      <center><h3 class="text-center"><a href="#get">GET DATA REQUEST FORMAT</a></h3></center>
                                      <hr>
                                        <h4>Response Body: </h4>
                                        <hr>
    ...
    "data": [
        {
            ...
            "updated_at": "2020-08-06T11:37:46.000000Z"
                                ...
                                <div class="col-md-12">
                                  <div class="card" style="padding: 20px;">
                                    <b class="btn btn-primary">POST</b> <strong><?=$DOMAIN?>/api/PostSmartIR</strong>
                                    <p>digunakan untuk menambah/mengubah data Smart IR, mengunakan token user qnesys/hotel</p>
                                    <hr>
                                    <h4>Request Header: </h4>
                                    <hr>
                                    <table border="1" width="100%">
                                ...
                                <div class="col-md-12">
                                 <div class="card" style="padding: 20px;">
                                   <b class="btn btn-danger">POST</b> <strong><?=$DOMAIN?>/api/DeleteSmartIR</strong>
                                   <p>digunakan untuk menghapus data smart ir, mengunakan token user qnesys/hotel</p>
                                   <hr>
                                   <h4>Request Header: </h4>
                                   <hr>
                                   <table border="1" width="100%">
                            ...
                            <section id="smart_lock" class="tm-section">
                                <header>
                                    <h2 class="tm-blue-text tm-welcome-title tm-margin-b-45">Smart Lock</h2>
                                </header>
                                <div class="row">
                                  <div class="col-md-12">
                                    <div class="card" style="padding: 20px;">
                                      <b class="btn btn-success">POST</b> <strong><?=$DOMAIN?>/api/GetSmartLock</strong>
                                      <p>adalah Hardware Smart Lock</p>
                                      <center><h3 class="text-center"><a href="#get">GET DATA REQUEST FORMAT</a></h3></center>
                                      <hr>
                                        <h4>Response Body: </h4>
                                        <hr>
    ...
    "data": [
        {
            ...
            "updated_at": "2020-08-06T11:37:46.000000Z"
                                ...
                                <div class="col-md-12">
                                  <div class="card" style="padding: 20px;">
                                    <b class="btn btn-primary">POST</b> <strong><?=$DOMAIN?>/api/PostSmartLock</strong>
                                    <p>digunakan untuk menambah/mengubah data Smart Lock, mengunakan token user qnesys/hotel</p>
                                    <hr>
                                    <h4>Request Header: </h4>
                                    <hr>
                                    <table border="1" width="100%">
                                ...
                                <div class="col-md-12">
                                 <div class="card" style="padding: 20px;">
                                   <b class="btn btn-danger">POST</b> <strong><?=$DOMAIN?>/api/DeleteSmartLock</strong>
                                   <p>digunakan untuk menghapus data smart lock, mengunakan token user qnesys/hotel</p>
                                   <hr>
                                   <h4>Request Header: </h4>
                                   <hr>
                                   <table border="1" width="100%">
                            ...
                            <section id="smart_switch" class="tm-section">
                                <header>
                                    <h2 class="tm-blue-text tm-welcome-title tm-margin-b-45">Smart Switch</h2>
                                </header>
                                <div class="row">
                                  <div class="col-md-12">
                                    <div class="card" style="padding: 20px;">
                                      <b class="btn btn-success">POST</b> <strong><?=$DOMAIN?>/api/GetSmartSwitch</strong>
                                      <p>adalah Hardware smart Siwtch</p>
                                      <center><h3 class="text-center"><a href="#get">GET DATA REQUEST FORMAT</a></h3></center>
                                      <hr>
                                        <h4>Response Body: </h4>
                                        <hr>
    ...
    "data": [
        {
            ...
            "updated_at": "2020-08-06T11:37:46.000000Z"
                                ...
                                <div class="col-md-12">
                                  <div class="card" style="padding: 20px;">
                                    <b class="btn btn-primary">POST</b> <strong><?=$DOMAIN?>/api/PostSmartSwitch</strong>
                                    <p>digunakan untuk menambah/mengubah data Smart Switch, mengunakan token user qnesys/hotel</p>
                                    <hr>
                                    <h4>Request Header: </h4>
                                    <hr>
                                    <table border="1" width="100%">
                                ...
                                <div class="col-md-12">
                                 <div class="card" style="padding: 20px;">
                                   <b class="btn btn-danger">POST</b> <strong><?=$DOMAIN?>/api/DeleteSmartSwitch</strong>
                                   <p>digunakan untuk menghapus data smart switch, mengunakan token user qnesys/hotel</p>
                                   <hr>
                                   <h4>Request Header: </h4>
                                   <hr>
                                   <table border="1" width="100%">
